  ...
  return (
    ...
    <div id="addAppointmentModal" className="modal">
        ...
        <div className="modal-content">
          ...
          <label>
          Date: <input className="appointmentInput" type="date" placeholder= "mm/dd/yyyy" value={activity_date} onChange={(event) => {
          ...
          <label>
          Time: <input className="appointmentInput" type="time" placeholder="00:00 AM/PM" value={activity_time}onChange={(event) => {

  ...
  return (
    ...
    <div id="addAppointmentModal" className="modal">
        ...
        <div className="modal-content">
          ...
          <label>
          Date: <input className="appointmentInput" type="date" placeholder= " " value={activity_date} onChange={(event) => {
          ...
          <label>
          Time: <input className="appointmentInput" type="time" placeholder=" " value={activity_time}onChange={(event) => {
